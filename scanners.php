...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">Scanners</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="./img/scanners.jpg" alt="Scanners" class="img-fluid" style="max-width:100%">
                        <img src="./img/scanners.jpg" alt="Scanners" class="img-fluid" style="max-width:100%">
                        <img src="./img/scanners.jpg" alt="Scanners" class="img-fluid" style="max-width:100%">
                        <img src="./img/scanners.jpg" alt="Scanners" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    Un scientifique recrute un homme doté de pouvoirs psychiques extraordinaires pour qu'ils puisse détecter d'autres personnes comme lui. 
                    <br>
                    <strong>Acteur principal : Michael Ironside. Stephen Lack</strong>
                    </div>
                </div>
            </div>
