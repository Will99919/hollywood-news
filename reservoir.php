...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">Reservoir Dogs</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="./img/reservoirdogs.jpg" alt="Reservoir Dogs" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    Un chef de la mafia réunit une équipe de six criminels expérimentés dans le but de réaliser un grand braquage de bijouterie. 
                    <br>
                    <strong>Acteur principal : Harvey Keitel. Michael Madsen</strong>
                    </div>
                </div>
            </div>
