...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">John Wick</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="./img/johnwick.webp" alt="John Wick" class="img-fluid" style="max-width:100%">
                        <img src="./img/johnwick.webp" alt="John Wick" class="img-fluid" style="max-width:100%">
                        <img src="./img/johnwick.webp" alt="John Wick" class="img-fluid" style="max-width:100%">
                        <img src="./img/johnwick.webp" alt="John Wick" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    Un ancien tueur à gages sort de sa retraite pour retrouver les gangsters qui ont tué son chien et lui a tout pris. 
                    <br>
                    <strong>Acteur principal : Keanu Reeves</strong>
                    </div>
                </div>
            </div>
