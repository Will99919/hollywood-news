...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">Retour vers le future</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="./img/retourverslefuture.jpg" alt="Retour vers le future" class="img-fluid" style="max-width:100%">
                        <img src="./img/retourverslefuture.jpg" alt="Retour vers le future" class="img-fluid" style="max-width:100%">
                        <img src="./img/retourverslefuture.jpg" alt="Retour vers le future" class="img-fluid" style="max-width:100%">
                        <img src="./img/retourverslefuture.jpg" alt="Retour vers le future" class="img-fluid" style="max-width:100%">
                    </div>
                    ...
                    <br>
                    <strong>Acteur principal : Micheal J Fox. Christopher Lloyd</strong>
                    </div>
                </div>
            </div>
