...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">Halloween</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="./img/halloween.webp" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="./img/halloween.webp" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="./img/halloween.webp" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                        <img src="./img/halloween.webp" alt="affiche film training day" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    Quinze ans après avoir assassiné sa soeur le soir d'Halloween en 1963, Michael Myers s'échappe d'un hôpital psychiatrique et retourne dans la petite ville de Haddonfield pour tuer à nouveau. 
                    <br>
                    <strong>Acteur principal : Jamie Lee Curtis. Nancy Kyes. Nick Castle</strong>
                    </div>
                </div>
            </div>
            <div class="glide" style="margin-top:450px;">
                ...
                <li class="glide__slide" style="text-align:center;"><a href="./lotr.php"><img src="./img/LOTR.jpg" width="200px;" height="300px;" style="border-radius: 10px"></a></li>                         </ul>
                </div>
