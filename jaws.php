...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">Les dents de la mer</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="./img/jaws.jpg" alt="Les dents de la mer" class="img-fluid" style="max-width:100%">
                        <img src="./img/jaws.jpg" alt="Les dents de la mer" class="img-fluid" style="max-width:100%">
                        <img src="./img/jaws.jpg" alt="Les dents de la mer" class="img-fluid" style="max-width:100%">
                        <img src="./img/jaws.jpg" alt="Les dents de la mer" class="img-fluid" style="max-width:100%">
                    ...
                    <div class="col">
                    Un shérif local, un biologiste marin et un vieux marin font équipe pour chasser un grand requin blanc qui fait des ravages dans une station balnéaire.
                    <br>
                    <strong>Acteur principal : Roy Scheider</strong>
                    </div>
                </div>
            </div>
