...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">Kaamelott</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="./img/kaamelott.webp" alt="Kaamelott" class="img-fluid" style="max-width:100%">
                        <img src="./img/kaamelott.webp" alt="Kaamelott" class="img-fluid" style="max-width:100%">
                        <img src="./img/kaamelott.webp" alt="Kaamelott" class="img-fluid" style="max-width:100%">
                        <img src="./img/kaamelott.webp" alt="Kaamelott" class="img-fluid" style="max-width:100%">
                    ...
                    <br>
                    <strong>Acteur principal : Alexandre Astier</strong>
                    </div>
                </div>
            </div>
