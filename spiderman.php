...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">Spiderman 3</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="./img/spiderman3.jpg" alt="Spiderman 3" class="img-fluid" style="max-width:100%">
                        <img src="./img/spiderman3.jpg" alt="Spiderman 3" class="img-fluid" style="max-width:100%">
                        <img src="./img/spiderman3.jpg" alt="Spiderman 3" class="img-fluid" style="max-width:100%">
                        <img src="./img/spiderman3.jpg" alt="Spiderman 3" class="img-fluid" style="max-width:100%">
                    </div>
                    <div class="col">
                    Une étrange et sombre entité venue d'un autre monde se lie à Peter Parker et provoque un chaos intérieur alors qu'il affronte de nouveaux malfaiteurs ainsi que de nouvelles tentations et vengeances. 
                    <br>
                    <strong>Acteur principal : Tobey Maguire. Kristen Dunst </strong>
                    </div>
                </div>
            </div>
