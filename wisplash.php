...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">Wisplash</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="./img/wisplash.jpg" alt="Wisplash" class="img-fluid" style="max-width:100%">
                        <img src="./img/wisplash.jpg" alt="Wisplash" class="img-fluid" style="max-width:100%">
                        <img src="./img/wisplash.jpg" alt="Wisplash" class="img-fluid" style="max-width:100%">
                        <img src="./img/wisplash.jpg" alt="Wisplash" class="img-fluid" style="max-width:100%">
                    ...
                    <br>
                    <strong>Acteur principal : Miles Teller. J.K Simmons</strong>
                    </div>
                </div>
            </div>
