...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">Le seigneur des anneaux</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="./img/LOTR.jpg" alt="Le seigneur des anneaux" class="img-fluid" style="max-width:100%">
                        <img src="./img/LOTR.jpg" alt="Le seigneur des anneaux" class="img-fluid" style="max-width:100%">
                        <img src="./img/LOTR.jpg" alt="Le seigneur des anneaux" class="img-fluid" style="max-width:100%">
                        <img src="./img/LOTR.jpg" alt="Le seigneur des anneaux" class="img-fluid" style="max-width:100%">
                    </div>
                    ...
                    <br>
                    <strong>Acteur principal : Eligah Wood. Viggo Mortensen</strong>
                    </div>
                </div>
            </div>
