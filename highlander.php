...
<body>
    ...
    <div class="conatainer-fluid">
        <h1 style="text-align:center;">Highlander</h1>
        </div>
            <div class="container">
                <div class="row">
                    <div class="col">
                        <img src="./img/highlander.jpg" alt="Highlander" class="img-fluid" style="max-width:100%">
                        <img src="./img/highlander.jpg" alt="Highlander" class="img-fluid" style="max-width:100%">
                        <img src="./img/highlander.jpg" alt="Highlander" class="img-fluid" style="max-width:100%">
                        <img src="./img/highlander.jpg" alt="Highlander" class="img-fluid" style="max-width:100%">
                    </div>
                    ...
                    <br>
                    <strong>Acteur principal : Christophe Lambert</strong>
                    </div>
                </div>
            </div>
